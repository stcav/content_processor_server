 ...
 * @author stcav
 */
@WebServlet(name = "JMXProcessorServlet", urlPatterns = {"/JMXProcessorServlet"})
public class JMXProcessorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String resp="OK";
        // Registering MBeans
        // Adecuate the mbeans_register response from myDynamicMbeans to MbeanAbstract
        DynamicMBeanFactory.mbeans_register(Layout.PATHMBEANDESCRIPTOR, Layout.CONTENTPROCESSORSERVER);
        try {
