...
public class NotificadoPK implements Serializable {
    ...
    public String toString() {
        return "org.unicauca.stcav.persistence.entities.NotificadoPK[ noticiaidNoticia=" + noticiaidNoticia + ", usuarioidUsuario=" + usuarioidUsuario + " ]";
    }
