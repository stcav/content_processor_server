...
public class ContenidohasEtiquetasPK implements Serializable {
    ...
    public String toString() {
        return "org.unicauca.stcav.persistence.entities.ContenidohasEtiquetasPK[ contenidoidContenido=" + contenidoidContenido + ", etiquetasidEtiquetas=" + etiquetasidEtiquetas + " ]";
    }
