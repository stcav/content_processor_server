...
import org.unicauca.stcav.persistence.entities.Votacion;
...
public class VotacionJpaController implements Serializable {
    ...
    public VotacionJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Votacion votacion) throws RollbackFailureException, Exception {
    ...
    public void edit(Votacion votacion) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
